...
export default function Song({title, artist, album, albumCover, time, wasPlayed}) {
    return (
        <div className="flex border border-blue-900 rounded-lg bg-gray-100 mt-8">
            ...
            <div className="flex my-auto ml-auto">
                ...
                {wasPlayed && <div className="flex my-auto pr-10">
